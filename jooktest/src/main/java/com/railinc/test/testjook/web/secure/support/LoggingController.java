...
public class LoggingController extends SupportControllerBaseImpl implements MessageSourceAware {
	...
	protected void addMessage(ModelMap map, String msgKey, Object ... args) {
		String msg = msgKey;
	...
	@RequestMapping("logging/update")
	public String updateLogging(@RequestParam(value="n",required=true) String name,@RequestParam(value="l",required=true) String level, ModelMap map) {
