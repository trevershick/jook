...
INSERT INTO `downtime` VALUES (2,'jooktest',60,'2010-12-22 15:10:00','Here\'s your freaking contnet.',NULL,NULL,'2010-12-21 21:34:12','jook_support');
...
CREATE TABLE `interaction` (
  ...
  `unsecureUrl` varchar(255) DEFAULT NULL,
  `secureUrl` varchar(255) DEFAULT NULL,
  `active` bit(1) NOT NULL,
  `excludeApplications` bit(1) NOT NULL,
  `creator` varchar(255) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `lastModified` datetime DEFAULT NULL,
  `lastModifier` varchar(255) DEFAULT NULL,
...
INSERT INTO `interaction` VALUES (2,'tab','News','/jook/news.html?app=%app%','/jook/news.html?app=%app%','\0','\0','jook_adm','2010-12-21 21:01:28',NULL,NULL),(5,'popupext','Popup Ext','https://ehms.railinc.com','https://ehms.railinc.com','','\0','jook_adm','2010-12-21 21:01:28',NULL,NULL),(6,'tab','Documentation','/sample/documentation/index.html','/sample/documentation/index.html','','\0','jook_adm','2010-12-21 21:01:28',NULL,NULL),(7,'tab','Test Form','/jook/examples/feedback/new-feedback.htm','/jook/examples/feedback/new-feedback.htm','','\0','jook_adm','2010-12-21 21:01:28',NULL,NULL),(8,'tab','Inkling','https://railinc.inklingmarkets.com/widgets/markets/31636/trades/new?access_key=d108792657930665f2084b30b86efaab48af77157c68d1a70eaa65c85b18aa6bfd6016b0d0291b90&stylesheet_url=','https://railinc.inklingmarkets.com/widgets/markets/31636/trades/new?access_key=d108792657930665f2084b30b86efaab48af77157c68d1a70eaa65c85b18aa6bfd6016b0d0291b90&stylesheet_url=','','\0','jook_adm','2010-12-21 21:01:28',NULL,NULL),(9,'tab','Prefs Test',NULL,'/jook/examples/prefs/example.htm','','\0','jook_support','2010-12-21 21:13:07','2010-12-21 21:13:07','jook_support');
/*!40000 ALTER TABLE `interaction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `interaction_app`
--

DROP TABLE IF EXISTS `interaction_app`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `interaction_app` (
  `interaction_id` bigint(20) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  KEY `FKC0FE1E7428B77FC0` (`interaction_id`),
  CONSTRAINT `FKC0FE1E7428B77FC0` FOREIGN KEY (`interaction_id`) REFERENCES `interaction` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `interaction_app`
--

LOCK TABLES `interaction_app` WRITE;
/*!40000 ALTER TABLE `interaction_app` DISABLE KEYS */;
/*!40000 ALTER TABLE `interaction_app` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `interaction_role`
--
...
CREATE TABLE `interaction_role` (
  ...
  PRIMARY KEY (`provider_id`,`role_name`),
  KEY `FK5ECD668374444781` (`provider_id`),
  CONSTRAINT `FK5ECD668374444781` FOREIGN KEY (`provider_id`) REFERENCES `interaction` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `interaction_role`
--

LOCK TABLES `interaction_role` WRITE;
/*!40000 ALTER TABLE `interaction_role` DISABLE KEYS */;
INSERT INTO `interaction_role` VALUES (7,'jook_support');
/*!40000 ALTER TABLE `interaction_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lastuserview`
--

DROP TABLE IF EXISTS `lastuserview`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lastuserview` (
  `LUV_ID` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `lastuserview`
--

LOCK TABLES `lastuserview` WRITE;
/*!40000 ALTER TABLE `lastuserview` DISABLE KEYS */;
INSERT INTO `lastuserview` VALUES (1,'news','/','jook_support','2010-12-21 21:37:43');
/*!40000 ALTER TABLE `lastuserview` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `pref_group` VALUES (3,'EHMS','ws','Web Services','',NULL,NULL,NULL,NULL),(4,'EMIS','UI','EMIS','Test this shit out.',NULL,NULL,'2010-12-15 14:30:12','jook_support'),(5,'jook_prefs','jookprefsdefault','Default','','jook_support','2010-12-21 21:14:08','2010-12-21 21:14:08','jook_support');
...
CREATE TABLE `pref_spec` (
  ...
  KEY `FKB28AEC57B7AE58D7` (`SPEC_GROUP_ID`),
  CONSTRAINT `FKB28AEC57B7AE58D7` FOREIGN KEY (`SPEC_GROUP_ID`) REFERENCES `pref_group` (`GROUP_ID`),
...
INSERT INTO `pref_spec` VALUES (1,'max','string','Maximum Results','','88',3,NULL,NULL,NULL,NULL),(2,'pref1','string','Pref 1 Value','','Preferred Value 1',5,'jook_support','2010-12-21 21:14:29','2010-12-21 21:14:29','jook_support');
...
CREATE TABLE `pref_values` (
  ...
  KEY `FK3FCFDABE6D480725` (`PREF_SPEC_ID`),
  CONSTRAINT `FK3FCFDABE6D480725` FOREIGN KEY (`PREF_SPEC_ID`) REFERENCES `pref_spec` (`SPEC_ID`),
...
INSERT INTO `pref_values` VALUES (1,2,'jook_support','Preferred Value 2','unknown','2010-12-21 21:14:48','2010-12-21 21:16:37','jook_support');
...
INSERT INTO `provider` VALUES (1,'Jook Proper','/jook/client/interactions/1.0/interactions.json','/jook/secured/client/interactions/1.0/interactions.json','','\0','admin','2010-12-21 20:47:01',NULL,NULL);
/*!40000 ALTER TABLE `provider` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `provider_app`
--
...
CREATE TABLE `provider_app` (
  `provider_id` bigint(20) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  KEY `FKE70A4ED3611A4C3F` (`provider_id`),
  CONSTRAINT `FKE70A4ED3611A4C3F` FOREIGN KEY (`provider_id`) REFERENCES `provider` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `provider_app`
--

LOCK TABLES `provider_app` WRITE;
/*!40000 ALTER TABLE `provider_app` DISABLE KEYS */;
/*!40000 ALTER TABLE `provider_app` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `provider_role` (
  ...
  `role_name` varchar(255) NOT NULL,
  PRIMARY KEY (`provider_id`,`role_name`),
  KEY `FKFA474204611A4C3F` (`provider_id`),
  CONSTRAINT `FKFA474204611A4C3F` FOREIGN KEY (`provider_id`) REFERENCES `provider` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `provider_role`
--

LOCK TABLES `provider_role` WRITE;
/*!40000 ALTER TABLE `provider_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `provider_role` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2010-12-21 21:42:40
